...
public class SweDate implements java.io.Serializable {
  ...
  private static SwissEph swissEph = new SwissEph();
...
// //#endif /* TRACE0 */
  ...
  private static int init_dt() {
    ...
    if (!init_dt_done) {
      ...
      try {
        if ((fp = swissEph.swi_fopen(-1, "swe_deltat.txt", swissEph.swissData.ephepath, null)) == null &&
            (fp = swissEph.swi_fopen(-1, "sedeltat.txt", swissEph.swissData.ephepath, null)) == null) {
  ...
  */
  ...
  private int init_leapsec() {
    ...
    if (!init_leapseconds_done) {
      ...
      /* no error message if file is missing */
      try {
        if ((fp = swissEph.swi_fopen(-1, "seleapsec.txt", swissEph.swissData.ephepath, null)) == null)
...
//      swe_revjul(tjd_ut1, gregflag, &iyear, &imonth, &iday, &d);
  ...
  public SDate getUTCfromJDET(double tjd_et, boolean gregflag, SDate dt) {
    return getUTCfromJDET(tjd_et, gregflag, dt.year, dt.month, dt.day, dt.hour, dt.minute, dt.second);
  }
  public SDate getUTCfromJDET(double tjd_et, boolean gregflag, int iyear, int imonth, int iday, int ihour, int imin, double dsec) {
    ...
    double d, tjd, tjd_et_1972, tjd_ut, dret[] = new double[10];
    /*
...
//     swe_revjul(tjd, gregflag, iyear, imonth, iday, &d);
  ...
  public SDate getUTCfromJDUT1(double tjd_ut, boolean gregflag, SDate dt) {
    return getUTCfromJDUT1(tjd_ut, gregflag, dt.year, dt.month, dt.day, dt.hour, dt.minute, dt.second);
  }
  public SDate getUTCfromJDUT1(double tjd_ut, boolean gregflag, int iyear, int imonth, int iday, int ihour, int imin, double dsec) {
    ...
    return getUTCfromJDET(tjd_et, gregflag, iyear, imonth, iday, ihour, imin, dsec);
  }
