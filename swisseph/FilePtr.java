...
* files.
*/
class FilePtr implements java.io.Serializable {
  static final String useragent = "swisseph-java-1.76.00(00)";
  ...
  * byte could be read.
  */
  int readUnsignedByte() throws IOException, EOFException {
  ...
  */
  short readShort() throws IOException, EOFException {
    if (fc != null) {
      return mbb.getShort();
    }
  ...
  */
  String readLine() throws IOException, EOFException {
    if (fc != null) {
      cb.clear();
