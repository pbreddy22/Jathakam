...
////#endif /* TRACE0 */
   ...
   *
   *********************************************************/
  public void swe_split_deg(double ddeg, int roundflag, int ideg[], /* ideg is an integer used as an output parameter */
                            int imin[], /* integer used as an output parameter */
                            int isec[], /* integer used as an output parameter */
                            double dsecfr[], /* double used as an output parameter */
                            int isgn[] /* integer used as an output parameter */) {
    double dadd = 0;
    isgn[0] = 1;
    if (ddeg < 0) {
      isgn[0] = -1;
